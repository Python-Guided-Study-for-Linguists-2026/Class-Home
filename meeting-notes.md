...
- Launching Jupyter Lab 
   - Open a terminal, move into your project folder (`cd` is the command)
...
### Next week
- PyET Ch.2 Quickstart goes through _all_ essential topics very quickly. Don't worry if you don't get everything 100%. 
